...
function add_room() {
    ...
    xhr.onload = function () {
        ...
        if (this.responseText == 1) {
            ...
            alert('error', 'Server Down!-Room add failed');
        }
    }
...
function submit_edit_room() {
    ...
    xhr.onload = function () {
        ...
        modal.hide();
        if (this.responseText == 1) {
            alert('success', 'Room edit successfully');
            edit_room_form.reset();
            get_rooms();
        }
        else {
            alert('error', 'Server Down!-Room edit failed');
        }
    }
...
function toggle_status(id, val) {
    ...
    xhr.onload = function () {
        if (this.responseText == 1) {
            ...
            alert('error', 'Server down! - toggle');
        }
    }
...
function add_image() {
    ...
    xhr.onload = function () {
        if (this.responseText == 'inv_img') {
            ...
            alert('error', 'Image should be not uploaded', 'image-alert');
        }
        else {
    ...
    if (confirm("Are you sure, you want to delete this room?")) {
        ...
        xhr.onload = function () {
            if (this.responseText == 1) {
                ...
                alert('error', 'Room delete failed!');
            }
        }
